...
//look for scrolling and pizza resizing
*/
...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "images/pizza_min2.png";
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    //pizza size is always the same, that's why I put out of the loop
...
//Out of loop because it is a constant array
...
function updatePositions() {
  ...
  //Out of the loop because is static
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < 200; i++) {
    ...
    elem.src = "images/pizza_min2.png";
